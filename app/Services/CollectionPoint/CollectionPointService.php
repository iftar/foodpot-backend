...
class CollectionPointService
{
    ...
    public function create($data)
    {
        $collectionPoint = CollectionPoint::create([
            ...
            "set_quantity_per_person" => $data["set_quantity_per_person"],
    ...
    public function update(CollectionPoint $collectionPoint, $data)
    {
        $collectionPoint->update([
            ...
            "logo"               => $data["logo"] ?? $collectionPoint->logo,
            "unique_url"         => $data["unique_url"] ?? $collectionPoint->unique_url,
            'set_quantity_per_person'          => $data['set_quantity_per_person'] ?? $collectionPoint->set_quantity_per_person,
